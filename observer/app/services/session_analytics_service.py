...
class SessionAnalyticsService:
    ...
    async def update_metrics(
        ...
        Args:
            ...
            alerts: Clinical alerts generated for this analysis
        ...
        total_confidence = analytics.average_confidence * (analytics.emotion_count - 1)
        analytics.average_confidence = (total_confidence + confidence) / analytics.emotion_count

        # Update dominant category (most frequent)
        analytics.dominant_category = category

        # Update timing
        analytics.last_emotion_time = datetime.utcnow()
    ...
    def _update_vac_stats(self, analytics: SessionAnalytics, vac_data: Dict[str, float]) -> None:
        ...
        for dim in ["valence", "arousal", "connection"]:
            ...
            # Update min/max
            vac_stats[min_key] = round(min(vac_stats.get(min_key, current_value), current_value), 3)
