...
class StrategyRecommender:
    ...
    async def search_strategies(
        ...
        if criteria.strategy_type:
            stmt = stmt.where(TransitionStrategy.strategy_type == criteria.strategy_type)

        if criteria.evidence_level:
            stmt = stmt.where(TransitionStrategy.evidence_level == criteria.evidence_level)

        if criteria.difficulty_min is not None:
            stmt = stmt.where(TransitionStrategy.difficulty_level >= criteria.difficulty_min)

        if criteria.difficulty_max is not None:
            stmt = stmt.where(TransitionStrategy.difficulty_level <= criteria.difficulty_max)
        ...
        stmt = (
            stmt.order_by(TransitionStrategy.strategy_name)
