...
from app.models.multi_emotion_analysis import DetectedEmotion, MultiEmotionAnalysis
...
async def test_deep_feeling_exposure(test_db):
    ...
    msg = await chat_service.save_user_message(context)
    ...
    emotion = DetectedEmotion(
        confidence=0.9, prominence="primary", vac=[0.1, 0.2, 0.3], voice_alignment=0.85
    )
