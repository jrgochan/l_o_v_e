import pytest
from app.services.emotion_relationship_service import EmotionRelationshipService
...
def test_known_relationship_complementary(service):
    ...
    emotions = [
        ...
        {"emotion_name": "Gratitude", "vac": {}, "confidence": 0.8, "prominence": "primary"}
    ]
...
def test_infer_contradictory(service):
    ...
    emotions = [
        {"emotion_name": "A", "vac": {"valence": 0.8, "arousal": 0.6, "connection": 0}, "confidence": 0.9},
        {"emotion_name": "B", "vac": {"valence": -0.8, "arousal": 0.5, "connection": 0}, "confidence": 0.9}
    ]
...
def test_infer_masking(service):
    ...
    emotions = [
        {"emotion_name": "A", "vac": {"valence": -0.8, "arousal": 0.8, "connection":0}, "prominence": "primary", "confidence": 0.9},
        {"emotion_name": "B", "vac": {"valence": 0.8, "arousal": 0.2, "connection":0}, "prominence": "underlying", "confidence": 0.7}
    ]
...
def test_infer_complementary(service):
    ...
    emotions = [
        {"emotion_name": "A", "vac": {"valence": 0.5, "arousal": 0.5, "connection": 0.5}, "confidence": 0.9},
        {"emotion_name": "B", "vac": {"valence": 0.6, "arousal": 0.6, "connection": 0.6}, "confidence": 0.9}
    ]
...
def test_infer_amplifying(service):
    ...
    emotions = [
        {"emotion_name": "High", "vac": {"valence": -0.8, "arousal": 0.95, "connection": 0}, "confidence": 0.9},
        {"emotion_name": "Low", "vac": {"valence": -0.9, "arousal": 0.1, "connection": 0}, "confidence": 0.9}
    ]
...
def test_infer_sequential(service):
    ...
    emotions = [
        {"emotion_name": "First", "vac": {"valence": 0.0, "arousal": 0.2, "connection": 0}, "confidence": 0.9},
        {"emotion_name": "Second", "vac": {"valence": 0.5, "arousal": 0.8, "connection": 0}, "confidence": 0.9}
    ]
...
def test_infer_default_complementary(service):
    ...
    emotions = [
        {"emotion_name": "A", "vac": {"valence": 0, "arousal": 0, "connection": 0}, "confidence": 0.9},
        {"emotion_name": "B", "vac": {"valence": 0.6, "arousal": 0, "connection": 0}, "confidence": 0.9}
    ]
...
def test_no_clear_relationship(service):
    ...
    emotions = [
        {"emotion_name": "A", "vac": {"valence": 1.0, "arousal": 1.0, "connection": 1.0}, "confidence": 0.9},
        {"emotion_name": "B", "vac": {"valence": -1.0, "arousal": -1.0, "connection": -1.0}, "confidence": 0.9}
    ]
...
def test_reverse_masking_inference(service):
    ...
    emotions = [
        {"emotion_name": "Under", "vac": {"valence": 0.8, "arousal": 0.2, "connection":0}, "prominence": "underlying", "confidence": 0.7},
        {"emotion_name": "Top", "vac": {"valence": -0.8, "arousal": 0.8, "connection":0}, "prominence": "primary", "confidence": 0.9}
    ]
    rels = service.analyze_relationships(emotions)
    assert len(rels) == 1
    assert rels[0]["type"] == "masking"
