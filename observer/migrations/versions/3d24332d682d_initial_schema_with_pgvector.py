...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_atlas_definitions_category'), 'atlas_definitions', ['category'], unique=False)
    op.create_index(op.f('ix_atlas_definitions_emotion_name'), 'atlas_definitions', ['emotion_name'], unique=True)
    op.create_table('user_trajectory',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['dominant_emotion_id'], ['atlas_definitions.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_user_trajectory_dominant_emotion_id'), 'user_trajectory', ['dominant_emotion_id'], unique=False)
    op.create_index(op.f('ix_user_trajectory_session_id'), 'user_trajectory', ['session_id'], unique=False)
    op.create_index(op.f('ix_user_trajectory_timestamp'), 'user_trajectory', ['timestamp'], unique=False)
    op.create_index(op.f('ix_user_trajectory_user_id'), 'user_trajectory', ['user_id'], unique=False)
