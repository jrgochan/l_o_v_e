...
async def seed_strategies_from_file(
    ...
    for strategy_data in strategies:
        ...
        print(f"  ✅ ADD: '{strategy_name}' (difficulty: {strategy.difficulty_level}, evidence: {strategy.evidence_level})")
        added += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument('--verify-only', action='store_true', help='Only verify existing strategies')
