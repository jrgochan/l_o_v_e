...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_emotion_collections_name"),
        "emotion_collections",
        ["name"],
        unique=True,
    )
    ...
    op.create_foreign_key(
        None, "emotion_definitions", "emotion_collections", ["collection_id"], ["id"]
    )
    ...
    op.create_unique_constraint(
        "uq_collection_emotion_name",
        "emotion_definitions",
        ["collection_id", "emotion_name"],
    )
    ...
    op.create_index(
        op.f("ix_emotion_definitions_category"),
        "emotion_definitions",
        ["category"],
        unique=False,
    )
    op.create_index(
        op.f("ix_emotion_definitions_emotion_name"),
        "emotion_definitions",
        ["emotion_name"],
        unique=False,
    )
    op.create_index(
        op.f("ix_emotion_definitions_collection_id"),
        "emotion_definitions",
        ["collection_id"],
        unique=False,
    )
    ...
    op.drop_constraint(
        "category_transitions_from_category_to_category_key",
        "category_transitions",
        type_="unique",
    )
    ...
    op.create_index(
        op.f("ix_chat_messages_emotion_id"),
        "chat_messages",
        ["emotion_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_chat_sessions_started_at"),
        "chat_sessions",
        ["started_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_clinical_alerts_timestamp"),
        "clinical_alerts",
        ["timestamp"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_detected_emotions_analysis_id"),
        "detected_emotions",
        ["analysis_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_detected_emotions_emotion_id"),
        "detected_emotions",
        ["emotion_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_detected_emotions_prominence"),
        "detected_emotions",
        ["prominence"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_emotion_goals_session_id"),
        "emotion_goals",
        ["session_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_emotion_relationships_analysis_id"),
        "emotion_relationships",
        ["analysis_id"],
        unique=False,
    )
    ...
    op.drop_constraint(
        "journey_waypoints_journey_id_waypoint_index_key",
        "journey_waypoints",
        type_="unique",
    )
    ...
    op.create_index(
        op.f("ix_multi_emotion_analyses_created_at"),
        "multi_emotion_analyses",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_multi_emotion_analyses_message_id"),
        "multi_emotion_analyses",
        ["message_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_multi_emotion_analyses_session_id"),
        "multi_emotion_analyses",
        ["session_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_multi_emotion_analyses_three_way_enabled"),
        "multi_emotion_analyses",
        ["three_way_enabled"],
        unique=False,
    )
    ...
    op.drop_constraint(
        "pattern_strategies_pattern_id_strategy_id_key",
        "pattern_strategies",
        type_="unique",
    )
    op.drop_constraint(
        "pattern_strategies_pattern_id_fkey", "pattern_strategies", type_="foreignkey"
    )
    op.drop_constraint(
        "pattern_strategies_strategy_id_fkey", "pattern_strategies", type_="foreignkey"
    )
    op.drop_table_comment(
        "pattern_strategies",
    ...
    op.drop_constraint(
        "user_trajectory_dominant_emotion_id_fkey",
        "user_trajectory",
        type_="foreignkey",
    )
    op.create_foreign_key(
        None, "user_trajectory", "emotion_definitions", ["dominant_emotion_id"], ["id"]
    )
    op.alter_column(
        "users",
        "id",
...
def downgrade() -> None:
    ...
    op.create_foreign_key(
        "user_journeys_start_emotion_id_fkey",
        "user_journeys",
        "atlas_definitions",
        ["start_emotion_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "user_journeys_goal_emotion_id_fkey",
        "user_journeys",
        "atlas_definitions",
        ["goal_emotion_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "strategy_attempts_journey_id_fkey",
        "strategy_attempts",
        "user_journeys",
        ["journey_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "strategy_attempts_strategy_id_fkey",
        "strategy_attempts",
        "transition_strategies",
        ["strategy_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "session_analytics_session_id_fkey",
        "session_analytics",
        "chat_sessions",
        ["session_id"],
        ["id"],
    ...
    op.create_index(
        "idx_session_analytics_start_time",
        "session_analytics",
        ["start_time"],
        unique=False,
    )
    op.create_index(
        "idx_session_analytics_session",
        "session_analytics",
        ["session_id"],
        unique=True,
    )
    op.create_index(
        "idx_session_analytics_emotion_count",
        "session_analytics",
        ["emotion_count"],
        unique=False,
    )
    op.create_index(
        "idx_session_analytics_dominant_category",
        "session_analytics",
        ["dominant_category"],
        unique=False,
    )
    ...
    op.create_foreign_key(
        "pattern_strategies_strategy_id_fkey",
        "pattern_strategies",
        "transition_strategies",
        ["strategy_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "pattern_strategies_pattern_id_fkey",
        "pattern_strategies",
        "transition_patterns",
        ["pattern_id"],
        ["id"],
    ...
    op.create_index(
        "idx_pattern_strategies_pattern",
        "pattern_strategies",
        ["pattern_id"],
        unique=False,
    )
    op.create_index(
        "idx_pattern_strategies_order",
        "pattern_strategies",
        ["pattern_id", "recommendation_order"],
        unique=False,
    )
    op.alter_column(
        "pattern_strategies",
    ...
    op.drop_index(
        op.f("ix_multi_emotion_analyses_three_way_enabled"),
        table_name="multi_emotion_analyses",
    )
    op.drop_index(
        op.f("ix_multi_emotion_analyses_session_id"),
        table_name="multi_emotion_analyses",
    ...
    op.create_index(
        "idx_multi_emotion_three_way",
        "multi_emotion_analyses",
        ["three_way_enabled"],
        unique=False,
    )
    op.create_index(
        "idx_multi_emotion_session",
        "multi_emotion_analyses",
        ["session_id"],
        unique=False,
    )
    op.create_index(
        "idx_multi_emotion_message",
        "multi_emotion_analyses",
        ["message_id"],
        unique=False,
    )
    op.create_index(
        "idx_multi_emotion_created",
        "multi_emotion_analyses",
        ["created_at"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_model_assignments_model_name",
        "model_assignments",
        ["ai_model_name"],
        unique=False,
    )
    ...
    op.create_foreign_key(
        "journey_waypoints_journey_id_fkey",
        "journey_waypoints",
        "user_journeys",
        ["journey_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "journey_waypoints_emotion_id_fkey",
        "journey_waypoints",
        "atlas_definitions",
        ["emotion_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "emotion_goals_goal_emotion_id_fkey",
        "emotion_goals",
        "atlas_definitions",
        ["goal_emotion_id"],
        ["id"],
    ...
    op.create_foreign_key(
        "detected_emotions_emotion_id_fkey",
        "detected_emotions",
        "atlas_definitions",
        ["emotion_id"],
        ["id"],
    ...
    op.create_index(
        "idx_detected_emotions_emotion",
        "detected_emotions",
        ["emotion_id"],
        unique=False,
    )
    op.create_index(
        "idx_detected_emotions_analysis",
        "detected_emotions",
        ["analysis_id"],
        unique=False,
    )
    ...
    op.create_foreign_key(
        "clinical_alerts_session_id_fkey",
        "clinical_alerts",
        "chat_sessions",
        ["session_id"],
        ["id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "vac_vector",
            pgvector.sqlalchemy.vector.VECTOR(dim=3),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column(
            "q_constant",
            pgvector.sqlalchemy.vector.VECTOR(dim=4),
            autoincrement=False,
            nullable=False,
        ),
        sa.Column(
    ...
    op.create_index(
        "ix_atlas_definitions_emotion_name",
        "atlas_definitions",
        ["emotion_name"],
        unique=True,
    )
