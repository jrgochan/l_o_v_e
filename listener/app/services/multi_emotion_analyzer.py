...
class MultiEmotionAnalyzer:
    ...
    async def _refresh_prompts(self) -> None:
        ...
        try:
            ...
            user_defaults = {
                "multi_emotion": MULTI_EMOTION_USER,
                "content_only": CONTENT_ONLY_USER,
                "voice_only": VOICE_ONLY_USER,
            }

            system_defaults = {
                "multi_emotion": MULTI_EMOTION_SYSTEM,
                "content_only": CONTENT_ONLY_SYSTEM,
                "voice_only": VOICE_ONLY_SYSTEM,
            }
