...
class TestModelFetcher:
    ...
    def setup_method(self):
        ...
        app.services.model_fetcher._fetcher_instance = None

    @pytest.mark.asyncio
    async def test_get_model_for_function_cache_hit(self):
    ...
    @pytest.mark.asyncio
    async def test_get_model_for_function_cache_miss_success(self):
    ...
    @pytest.mark.asyncio
    async def test_get_model_for_function_error_fallback(self):
    ...
    @pytest.mark.asyncio
    async def test_get_model_for_function_cache_expired(self):
    ...
    @pytest.mark.asyncio
    async def test_get_prompt_for_function_success(self):
    ...
    @pytest.mark.asyncio
    async def test_get_prompt_for_function_not_found_404(self):
    ...
    @pytest.mark.asyncio
    async def test_get_prompt_for_function_not_found_msg(self):
    ...
    @pytest.mark.asyncio
    async def test_get_prompt_for_function_error(self):
    ...
    @pytest.mark.asyncio
    async def test_get_prompt_cache_hit(self):
    ...
    @pytest.mark.asyncio
    async def test_get_prompt_expired_cache(self):
    ...
    def test_singleton_get_model_fetcher(self):
