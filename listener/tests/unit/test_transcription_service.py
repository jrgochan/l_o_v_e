...
class TestTranscriptionService:
    ...
    def test_init_mps_detection(self):
        ...
        with patch('app.services.transcription.logging') as mock_log:
            service = TranscriptionService(device="mps")
            # Should log info
            # mock_log.getLogger.return_value.info.assert_called_with("Using MPS (Metal Performance Shaders) acceleration for Whisper")
