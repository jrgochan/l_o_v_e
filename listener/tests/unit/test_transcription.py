...
class TestTranscriptionService:
    ...
    def test_get_model_info(self):
        ...
        assert info["loaded"] == False  # Not loaded until first use
...
@pytest.mark.slow
@pytest.mark.skipif(
    not Path("tests/fixtures/sample.wav").exists(),
    reason="No sample audio file available"
)
class TestTranscriptionWithAudio:
    ...
    def test_transcription_latency(self, fixtures_dir):
        ...
        assert result.transcription_time_seconds < max_latency, \
