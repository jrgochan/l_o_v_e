...
class TestFullPipeline:
    ...
    async def test_text_to_vac_pipeline(self, sample_text):
        ...
        print(f"   VAC: V={emotion.vac.valence:.2f}, A={emotion.vac.arousal:.2f}, C={emotion.vac.connection:.2f}")
    ...
    def test_pii_detection_and_scrubbing(self):
        ...
        assert "Kaiser Hospital" not in sanitized or "[ORG]" in sanitized or "[LOCATION]" in sanitized
