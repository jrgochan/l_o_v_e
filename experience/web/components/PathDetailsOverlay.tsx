            ...
            >
                ...
                <div className="flex-1 flex flex-col justify-center gap-1 min-w-[300px]">
                    ...
                    <div className="relative h-1.5 bg-white/10 rounded-full w-full group cursor-pointer overflow-hidden">
                        ...
                        <div className="absolute top-1/2 left-0 w-full -translate-y-1/2 flex justify-between px-[2px] pointer-events-none">
                            {/* Start Point */}
                            <div className={`rounded-full transition-all duration-300 ${currentIndex === 0 ? 'w-2.5 h-2.5 shadow-lg scale-125' : 'w-1.5 h-1.5 opacity-50'}`}
                            ...
                            {/* End Point */}
                            <div className={`rounded-full transition-all duration-300 ${currentIndex === totalPoints - 1 ? 'w-2.5 h-2.5 shadow-lg scale-125' : 'w-1.5 h-1.5 opacity-50'}`}
                            ...
                            {itemTransitions((style, item) => (
                                item && (
                                    <animated.div style={style} className="flex items-center gap-2">
                                        ...
                                        >
                                            {categoryInfo.index > 0 ? String(categoryInfo.index).padStart(2, '0') : "--"}
                                        </span>
                                        {/* Colored Label */}
                ...
                <div className="flex items-center gap-4 mr-1">
                    ...
                    <div className="flex flex-col items-center gap-1 group">
                        ...
                        <span className="text-[7px] text-white/20 uppercase tracking-widest font-semibold group-hover:text-white/40 transition-colors">Category</span>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1 group">
                        ...
                        <span className="text-[7px] text-white/20 uppercase tracking-widest font-semibold group-hover:text-white/40 transition-colors">Step</span>
                    </div>
                </div>
