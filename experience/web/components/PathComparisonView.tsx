              ...
              <div className="grid grid-cols-2 gap-y-4 gap-x-8 mb-8">
                <div>
                  ...
                  <div className="text-xl font-light text-white">
                    {path.path_metrics?.estimated_time || "~30m"}
                  </div>
                </div>
                <div>
                  <div className="text-[10px] text-white/30 uppercase tracking-widest mb-1">
                  ...
                  <div
                    className={`text-xl font-light capitalize ${getDifficultyColor(path.path_metrics?.difficulty)}`}
                  >
                ...
                <div>
                  ...
                  <div className="text-xl font-light text-white">
                    {path.path_metrics?.requires_bridge
                      ? path.path_metrics.bridge_emotions?.length
                      : 0}
                  </div>
                </div>
              </div>
