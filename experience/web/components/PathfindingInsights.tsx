  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-xl p-4 mt-6">
       <div className="flex items-center gap-2 mb-3">
          <span className="text-sm font-mono text-white/50 uppercase tracking-widest">Algorithm Insights</span>
       </div>

       <div className="grid grid-cols-2 gap-3">
           <MetricCard label="Nodes Explored" termKey="NODES_EXPLORED" value={metrics.nodes_explored} />
...
const MetricCard = ({ label, value, termKey }: { label: string, value: string | number, termKey?: string }) => (
