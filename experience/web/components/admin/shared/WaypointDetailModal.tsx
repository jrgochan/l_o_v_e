        ...
        <div className="flex-1 overflow-y-auto p-6">
          {activeTab === "why" && (
            <div className="space-y-6">
              ...
              {/* Extended Dimension Forecast (Octonion) */}
              {(() => {
                const currentEmotion = allEmotions.find((e) => e.name === currentStep.emotion);
                const prevEmotion = previousEmotion
                  ? allEmotions.find((e) => e.name === previousEmotion.emotion)
                  : null;
                if (!currentEmotion?.extended) return null;
