...
describe("EmotionAnimationMapper", () => {
    ...
    describe("getEmotionAnimationParams", () => {
        ...
        it("should correct glow intensity for valid bridge emotion (Love)", () => {
            ...
            const loveEmotion = { ...baseEmotion, name: "Love", vac: [0, 0, 0.8] as [number, number, number] };
            const regularEmotion = { ...baseEmotion, name: "Regular", vac: [0, 0, 0.8] as [number, number, number] };
