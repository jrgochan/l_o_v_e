...
import {
  InnerCharacterSphere,
  MotionIndicator,
} from "@/components/admin/spheres/InnerCharacterSphere";
...
describe("InnerCharacterSphere", () => {
  ...
  it("registers animation loop and updates mesh", () => {
    ...
    const { container } = render(
      <InnerCharacterSphere emotion={mockEmotion as any} mode="dynamic" />
    );
  ...
  it("handles orbital motion", () => {
    ...
    const { container } = render(
      <InnerCharacterSphere emotion={orbitalEmotion as any} mode="dynamic" />
    );
    const mesh = container.querySelector("mesh") as any;
