...
const Wrapper = ({ children }: { children: React.ReactNode }) => <Command>{children}</Command>;
...
describe("PaletteResults", () => {
  ...
  it("renders quick actions when search starts with /", () => {
    const quickActions = [{ command: "/test", description: "Test command" }];
    render(
      <Wrapper>
  ...
  it("renders category drill-down", () => {
    const emotionsByCategory = new Map([["Positive", [mockEmotion]]]);
