...
describe("StepAlternativeSelector", () => {
  ...
  it("handles API errors gracefully", async () => {
    (therapeuticService.getStepAlternatives as jest.Mock).mockRejectedValue(
  ...
  it("calls updateWaypoint and onClose when alternative is selected", async () => {
    ...
    expect(mockUpdateWaypoint).toHaveBeenCalledWith(
      1,
