...
describe("useMatrixStats", () => {
    ...
    it("should calculate correct statistics", () => {
        const { result } = renderHook(() => useMatrixStats({ allEmotions: mockEmotions, computedPaths: mockPaths }));
    ...
    it("should handle empty state", () => {
        const { result } = renderHook(() => useMatrixStats({ allEmotions: [], computedPaths: new Map() }));
