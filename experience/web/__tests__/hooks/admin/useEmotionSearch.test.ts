...
describe("useEmotionSearch", () => {
    const mockEmotions: AtlasEmotion[] = [
        { id: "1", name: "Joy", category: "Positive", definition: "", vac: [0, 0, 0], quaternion: { x: 0, y: 0, z: 0, w: 1 }, color_hint: "" },
        { id: "2", name: "Sadness", category: "Negative", definition: "", vac: [0, 0, 0], quaternion: { x: 0, y: 0, z: 0, w: 1 }, color_hint: "" },
        { id: "3", name: "Anger", category: "Negative", definition: "", vac: [0, 0, 0], quaternion: { x: 0, y: 0, z: 0, w: 1 }, color_hint: "" },
    ];
