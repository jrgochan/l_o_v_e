...
describe("useCategoryState", () => {
    const mockEmotions: AtlasEmotion[] = [
        { id: "1", name: "Joy", category: "Positive", definition: "", vac: [0, 0, 0], quaternion: {}, color_hint: "" },
        { id: "2", name: "Excitement", category: "Positive", definition: "", vac: [0, 0, 0], quaternion: {}, color_hint: "" },
        { id: "3", name: "Sadness", category: "Negative", definition: "", vac: [0, 0, 0], quaternion: {}, color_hint: "" },
    ];

    it("should group emotions by category", () => {
        const { result } = renderHook(() => useCategoryState({
