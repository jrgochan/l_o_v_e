...
describe("messageDispatcher", () => {
    ...
    it("should dispatch multi_emotion message", () => {
        ...
        dispatchMessage(payload as any, mockHandlers);
        expect(mockHandlers.onMultiEmotion).toHaveBeenCalledWith("Awe", "Deep", payload.vac, 0.85, "primary");
    });
    ...
    it("should dispatch emotion_relationship message", () => {
        ...
        dispatchMessage(payload as any, mockHandlers);
        expect(mockHandlers.onRelationship).toHaveBeenCalledWith("Joy", "Sadness", "contradictory", 0.7, "Mixed feelings");
    });
    ...
    it("should dispatch progress_update message", () => {
        ...
        dispatchMessage(payload as any, mockHandlers);
        expect(mockHandlers.onProgressUpdate).toHaveBeenCalledWith("semantic", "processing", "Analyzing...", 50, 100);
    });
