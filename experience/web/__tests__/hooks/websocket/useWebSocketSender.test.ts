...
describe("useWebSocketSender", () => {
    ...
    it("should send text message when connected", () => {
        ...
        result.current.sendMessage("Hello", "empathetic", false);
    ...
    it("should send audio message when connected", () => {
        ...
        result.current.sendAudio("base64data", "assertive", true);

        expect(wsMock.send).toHaveBeenCalledWith(
            JSON.stringify({
                type: "user_message",
                audio_data: "base64data",
                tone_preference: "assertive",
    ...
    it("should update tone preference", () => {
        ...
        result.current.updateTonePreference('direct');
    ...
    it("should handle disconnected state for text message", () => {
        ...
        result.current.sendMessage("Fail", "empathetic");
    ...
    it("should handle disconnected state for audio message", () => {
        ...
        result.current.sendAudio("Fail", "empathetic");
