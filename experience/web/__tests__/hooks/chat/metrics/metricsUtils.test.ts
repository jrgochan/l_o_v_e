import { calculateUpdatedMetrics, calculateIncrementedAlert, createInitialMetrics } from "@/hooks/chat/metrics/metricsUtils";
    ...
    describe("calculateUpdatedMetrics", () => {
        ...
        it("should trigger critical alert on high arousal/low valence", () => {
            const updated = calculateUpdatedMetrics(
                ...
                "fear",
                "fear",
                { valence: -0.8, arousal: 0.9, dominance: 0.5 }, // Trigger critical
                0.9
            );
