...
describe("usePathSync", () => {
    ...
    const mockPath = {
        ...
        to: { id: "e2", name: "Sadness", category: "Negative", vac: [-1, 0, 0], quaternion: [0, 0, 0, 1] },
        waypoints: [
    ...
    it("should sync selected path to experience store", () => {
        ...
        (useAtlasAdminStore as unknown as jest.Mock).mockImplementation((selector) => {
            const state = {
                ...
                computedPaths: { get: (id) => id === "e1-e2" ? mockPath : undefined },
        ...
        expect(mockSetTransitionPath).toHaveBeenCalledWith(expect.objectContaining({
            path_id: "e1-e2",
