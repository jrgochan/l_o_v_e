...
final class SoulViewTests: XCTestCase {
    ...
    func testSoulViewInit() throws {
        ...
        let emotions = [Emotion(name: "Joy", definition: "Happy", category: "Happy", valence: 0.8, arousal: 0.5, connection: 0.5)]
        ...
        // Note: ViewInspector struggles inspecting INSIDE a NSViewRepresentable unless we provide custom inspection hooks.
