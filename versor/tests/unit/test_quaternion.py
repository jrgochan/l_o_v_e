...
class TestQuaternionConjugate:
    ...
    def test_conjugate_is_inverse_for_unit_quaternions(self):
...
class TestQuaternionMultiplication:
    ...
    def test_multiplication_preserves_unit_norm(self):
...
class TestQuaternionDotProduct:
    ...
    def test_dot_with_identity(self):
...
class TestAxisAngleConstruction:
    ...
    def test_axis_angle_produces_unit_quaternion(self):
        ...
        axis = tuple(x/mag for x in axis_raw)
        angle = math.pi / 3
