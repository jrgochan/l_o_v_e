...
class TestShortestPath:
    ...
    def test_negative_dot_negates_q2(self):
    ...
    def test_corrected_dot_is_positive(self):
...
class TestSLERPPath:
    ...
    def test_slerp_endpoints_match(self):
    ...
    def test_all_path_quaternions_unit(self):
    ...
    def test_identical_quaternions_constant_path(self):
...
class TestSLERPSemantics:
    ...
    def test_joy_to_shame_smooth_path(self):
    ...
    def test_pity_to_compassion_path(self):
...
class TestSmoothing:
    ...
    def test_alpha_intermediate_blends(self):
