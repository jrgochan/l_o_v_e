...
files_to_fix = {
    "app/api/routes/history.py": {267: ("async def get_history", ") -> Dict[str, Any]:")},
    "app/api/routes/chat_websocket.py": {757: ("async def generate_insights", ") -> None:")},
    "app/api/routes/bootstrap.py": {
        ...
        367: (
            "def _fetch_context_modifiers(db_rows)",
            "def _fetch_context_modifiers(db_rows: Any)",
        ),
        401: ("async def get_context_recommendations", ") -> Dict[str, Any]:"),
        472: ("async def get_challenge_patterns", ") -> Dict[str, Any]:"),
    },
    "app/websocket/routes.py": {192: ("async def websocket_endpoint", ") -> None:")},
    "app/api/routes/state.py": {263: ("async def record_state", ") -> Dict[str, Any]:")},
