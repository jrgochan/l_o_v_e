...
fixes = [
    ...
    (
        ...
        690,
        "def _to_python_list(vac_vector: Any)",
        "def _to_python_list(vac_vector)",
    ),
    (
        "app/api/routes/transitions.py",
        695,
    ...
    (
        "app/api/routes/transitions.py",
        749,
        "def _generate_waypoint_reasoning(waypoint_emotion: Any, path: Any)",
        "def _generate_waypoint_reasoning(waypoint_emotion, path)",
    ),
    ...
    (
        ...
        341,
        "modifier: Any, modifier_type_name",
        "modifier, modifier_type_name",
    ),
